...
class Enemy(pygame.sprite.Sprite):
    ...
    def setImage(self):
        if self.row == 0:
            image = pygame.image.load('img/alien1.png')
        elif self.row == 1:
            image = pygame.image.load('img/alien2.png')
        elif self.row == 2:
            image = pygame.image.load('img/alien3.png')
        else:
            image = pygame.image.load('img/alien1.png')
        image.convert_alpha()
...
class App(object):
    def __init__(self):
        ...
        self.laserSound = pygame.mixer.Sound('snd/laser.ogg')
        self.startLaser = pygame.mixer.Sound('snd/alienLaser.ogg')
    ...
    def resetGame(self):
        ...
        self.introMessage1 = Text('font/orena.ttf', 25,
                                    'Welcome to Space Invaders!',
                                    GREEN, self.displayRect,
                                    self.displaySurf)

        self.introMessage2 = Text('font/orena.ttf', 20,
        ...
        self.gameOverMessage = Text('font/orena.ttf', 25,
                                    'GAME OVER', GREEN,
